...
S3 Versioning is a feature that keeps multiple versions of an object in the same bucket, protecting against accidental deletion and overwrites.
...
Versioning can be enabled at any time after bucket creation.

3. Can Versioning be Disabled?

Answer:

Versioning cannot be completely removed.
...
S3 adds a Delete Marker instead of permanently deleting the object.
...
A delete marker is a special version that makes an object appear deleted while retaining all previous versions.
